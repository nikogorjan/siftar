...
export type Contact144Props = React.ComponentPropsWithoutRef<"section"> &
  Partial<Props>;

export const Contact144 = (props: Contact144Props) => {
  const router = useRouter();
  const t = useTranslations("contacts");
  const tt = useTranslations("bookingInstructions");
    ...
    <section id="relume" className="px-[5%] py-16">
      <div className="container max-w-lg">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          <h2 className="info-header mtb mbottom">{tt("step6")}</h2>
        </div>
...
Contact144.displayName = "Contact144";

export default Contact144;
